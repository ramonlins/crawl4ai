...
```
curl --request POST \
  --url 'https://api-mainnet.helius-rpc.com/v0/transactions?api-key=' \
...
array
required
An array of transaction signatures to parse.
#### Authorizations
api-key
string
query
...
Yes
[Previous](https://www.helius.dev/docs/api-reference/enhanced-transactions/overview)[ Get Transactions By AddressRetrieve complete parsed transaction history for a Solana address with human-readable data, transaction type filtering, and pagination support  Next ](https://www.helius.dev/docs/api-reference/enhanced-transactions/gettransactionsbyaddress)
Returns an array of enhanced, human-readable versions of the given transactions.
cURL
