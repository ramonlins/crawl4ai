"""
Scrape all content from https://www.helius.dev/docs using crawl4ai deep crawling.
Output: helius_docs/ directory with one markdown file per page.
"""
...
OUTPUT_DIR = "helius_docs"
BASE_URL = "https://www.helius.dev/docs"
...
async def main():
    ...
    filter_chain = FilterChain(filters=[
        DomainFilter(allowed_domains=["www.helius.dev", "helius.dev"]),
        URLPatternFilter(patterns=["https://www.helius.dev/docs/*", "https://helius.dev/docs/*"]),
    ])
